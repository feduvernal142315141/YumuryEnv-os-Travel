...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-card shadow-xl transition ease-[var(--ease-out-soft)] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-200 data-[state=open]:duration-300",
  {
    variants: {
      side: {
...
export const SheetFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn(
      "mt-auto flex flex-col gap-2 px-6 py-4 border-t border-border-subtle",
      className,
    )}
    {...props}
  />
